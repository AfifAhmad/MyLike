...
class MyLike__Crypt__Rijndael extends MyLike__Crypt__Base {
	...
	const CRYPT_RIJNDAEL_MODE_CTR = MyLike__Crypt__Base::CRYPT_MODE_CTR;
	const CRYPT_RIJNDAEL_MODE_ECB = MyLike__Crypt__Base::CRYPT_MODE_ECB;
	const CRYPT_RIJNDAEL_MODE_CBC = MyLike__Crypt__Base::CRYPT_MODE_CBC;
	const CRYPT_RIJNDAEL_MODE_CFB = MyLike__Crypt__Base::CRYPT_MODE_CFB;
	const CRYPT_RIJNDAEL_MODE_OFB = MyLike__Crypt__Base::CRYPT_MODE_OFB;
	const CRYPT_RIJNDAEL_MODE_INTERNAL = MyLike__Crypt__Base::CRYPT_MODE_INTERNAL;
	const CRYPT_RIJNDAEL_MODE_MCRYPT = MyLike__Crypt__Base::CRYPT_MODE_MCRYPT;

    public function __construct($mode = self::CRYPT_RIJNDAEL_MODE_CBC)
    {
    ...
    {
        if (constant('CRYPT_' . $this->const_namespace . '_MODE') == MyLike__Crypt__Base::CRYPT_MODE_INTERNAL) {
        ...
        switch (true) {
            ...
            case !in_array($cipher_name_mcrypt, mcrypt_list_algorithms()): // $cipher_name_mcrypt is not available for the current $block_size
                $engine = MyLike__Crypt__Base::CRYPT_MODE_INTERNAL;
                break;
            default:
                $engine = MyLike__Crypt__Base::CRYPT_MODE_MCRYPT;
        }
