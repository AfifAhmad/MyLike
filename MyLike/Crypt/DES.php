...
class MyLike__Crypt__DES extends MyLike__Crypt__Base {
	...
	const CRYPT_DES_MODE_CTR = MyLike__Crypt__Base::CRYPT_MODE_CTR;
	const CRYPT_DES_MODE_ECB = MyLike__Crypt__Base::CRYPT_MODE_ECB;
	const CRYPT_DES_MODE_CBC = MyLike__Crypt__Base::CRYPT_MODE_CBC;
	const CRYPT_DES_MODE_CFB = MyLike__Crypt__Base::CRYPT_MODE_CFB;
	const CRYPT_DES_MODE_OFB = MyLike__Crypt__Base::CRYPT_MODE_OFB;
	const CRYPT_DES_MODE_INTERNAL = MyLike__Crypt__Base::CRYPT_MODE_INTERNAL;
	const CRYPT_DES_MODE_MCRYPT = MyLike__Crypt__Base::CRYPT_MODE_MCRYPT;

    public function __construct($mode = self::CRYPT_DES_MODE_CBC)
    {
