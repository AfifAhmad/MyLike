...
class MyLike__Crypt__Twofish extends MyLike__Crypt__Base {
    ...
    protected $S3 = array();
    protected $kl;
	const CRYPT_TWOFISH_MODE_CTR = MyLike__Crypt__Base::CRYPT_MODE_CTR;
	const CRYPT_TWOFISH_MODE_ECB = MyLike__Crypt__Base::CRYPT_MODE_ECB;
	const CRYPT_TWOFISH_MODE_CBC = MyLike__Crypt__Base::CRYPT_MODE_CBC;
	const CRYPT_TWOFISH_MODE_CFB = MyLike__Crypt__Base::CRYPT_MODE_CFB;
	const CRYPT_TWOFISH_MODE_OFB = MyLike__Crypt__Base::CRYPT_MODE_OFB;
	
    public function __construct($mode = self::CRYPT_TWOFISH_MODE_ECB)
    {
